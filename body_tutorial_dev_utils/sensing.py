    ...
    def __init__(self, model: MjModel) -> None:
        self._sensors = {
            "walker/accelerometer": _WeightedSumSensor(
                ...
                indices=_sensor_data_indices(model, "walker/accelerometer"),
            ...
            "walker/force": _WeightedSumSensor(
                field_name="sensordata",
                indices=_sensor_data_indices(model, "walker/force_*"),
                kernel="mean-sub-second-for-first",
            ),
            "walker/gyro": _WeightedSumSensor(
                field_name="sensordata",
                indices=_sensor_data_indices(model, "walker/gyro"),
                kernel="mean",
            ),
            ...
            "walker/touch": _WeightedSumSensor(
                field_name="sensordata",
                indices=_sensor_data_indices(model, "walker/touch_*"),
                kernel="mean-sub-second-for-first",
            ),
            "walker/velocimeter": _WeightedSumSensor(
                field_name="sensordata",
                indices=_sensor_data_indices(model, "walker/velocimeter"),
                kernel="mean",
            ),
            "walker/world_zaxis": _LastValueSensor(
                field_name="xmat",
                indices=_xmat_indices(model, "walker/thorax")[6:],
            ),
            "walker/appendages_pos": _AppendagePositionSensor(
                root_body_id=model.body("walker/thorax").id,
...
def _observed_joint_names() -> list[str]:
    return [
        ...
        "walker/head_twist",
        "walker/head",
        "walker/abdomen_abduct",
        "walker/abdomen",
        "walker/abdomen_abduct_2",
        "walker/abdomen_2",
        "walker/abdomen_abduct_3",
        "walker/abdomen_3",
        "walker/abdomen_abduct_4",
        "walker/abdomen_4",
        "walker/abdomen_abduct_5",
        "walker/abdomen_5",
        "walker/abdomen_abduct_6",
        "walker/abdomen_6",
        "walker/abdomen_abduct_7",
        "walker/abdomen_7",
        "walker/haltere_left",
        "walker/haltere_right",
        "walker/coxa_abduct_T1_left",
        "walker/coxa_twist_T1_left",
        "walker/coxa_T1_left",
        "walker/femur_twist_T1_left",
        "walker/femur_T1_left",
        "walker/tibia_T1_left",
        "walker/tarsus_T1_left",
        "walker/tarsus2_T1_left",
        "walker/tarsus3_T1_left",
        "walker/tarsus4_T1_left",
        "walker/tarsus5_T1_left",
        "walker/coxa_abduct_T1_right",
        "walker/coxa_twist_T1_right",
        "walker/coxa_T1_right",
        "walker/femur_twist_T1_right",
        "walker/femur_T1_right",
        "walker/tibia_T1_right",
        "walker/tarsus_T1_right",
        "walker/tarsus2_T1_right",
        "walker/tarsus3_T1_right",
        "walker/tarsus4_T1_right",
        "walker/tarsus5_T1_right",
        "walker/coxa_abduct_T2_left",
        "walker/coxa_twist_T2_left",
        "walker/coxa_T2_left",
        "walker/femur_twist_T2_left",
        "walker/femur_T2_left",
        "walker/tibia_T2_left",
        "walker/tarsus_T2_left",
        "walker/tarsus2_T2_left",
        "walker/tarsus3_T2_left",
        "walker/tarsus4_T2_left",
        "walker/tarsus5_T2_left",
        "walker/coxa_abduct_T2_right",
        "walker/coxa_twist_T2_right",
        "walker/coxa_T2_right",
        "walker/femur_twist_T2_right",
        "walker/femur_T2_right",
        "walker/tibia_T2_right",
        "walker/tarsus_T2_right",
        "walker/tarsus2_T2_right",
        "walker/tarsus3_T2_right",
        "walker/tarsus4_T2_right",
        "walker/tarsus5_T2_right",
        "walker/coxa_abduct_T3_left",
        "walker/coxa_twist_T3_left",
        "walker/coxa_T3_left",
        "walker/femur_twist_T3_left",
        "walker/femur_T3_left",
        "walker/tibia_T3_left",
        "walker/tarsus_T3_left",
        "walker/tarsus2_T3_left",
        "walker/tarsus3_T3_left",
        "walker/tarsus4_T3_left",
        "walker/tarsus5_T3_left",
        "walker/coxa_abduct_T3_right",
        "walker/coxa_twist_T3_right",
        "walker/coxa_T3_right",
        "walker/femur_twist_T3_right",
        "walker/femur_T3_right",
        "walker/tibia_T3_right",
        "walker/tarsus_T3_right",
        "walker/tarsus2_T3_right",
        "walker/tarsus3_T3_right",
        "walker/tarsus4_T3_right",
        "walker/tarsus5_T3_right",
    ]
...
def _appendage_names() -> list[str]:
    return [
        "walker/claw_T1_left",
        "walker/claw_T1_right",
        "walker/claw_T2_left",
        "walker/claw_T2_right",
        "walker/claw_T3_left",
        "walker/claw_T3_right",
        "walker/head",
    ]
